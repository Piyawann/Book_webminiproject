...
<body>
    ...
    // $stmt = $pdo->prepare("SELECT หนังสือ.bname,หนังสือ.author,COUNT(บันทึกยืมคืน.isbn) as count from บันทึกยืมคืน
    //                         INNER JOIN หนังสือ ON (หนังสือ.isbn= บันทึกยืมคืน.isbn)
    //                         GROUP BY หนังสือ.bname ORDER BY `count`  DESC LIMIT 3;");
    // $stmt->execute();
...
<!-- /*ค้นหา*/ -->
    ...
    <section class="features" id="index">
        ...
        <div class="box-container">
            ...
            <div class="box">
                <img src="book/<?=$row["isbn"]?>.jpg" width="100">
                <h3><?=$row ["bname"]?></h3>
                <p><?=$row ["author"]?></p>
    ...
    <!-- <section class="features" id="features">
        <h1 class="heading">หนังสือยอดนิยม</h1>
        <div class="box-container">
            <?php while ($row = $stmt->fetch()) :?>
            <div class="box">
                <img src="book/<?=$row["isbn"]?>.jpg" width="100">
